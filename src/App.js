                ...
                <div className="relative">
                    ...
                    >
                        {selectedGradient === 'none'
                            ? 'Show Gradient'
                            : gradientData?.interpretations[selectedGradient]?.name || selectedGradient}
                        <ChevronDown size={14} className={`transition-transform duration-300 ${isGradientOpen ? 'rotate-180' : ''}`} />
                    </button>

                    {isGradientOpen && gradientData && (
                        <div className="absolute top-full left-0 mt-2 w-64 bg-[#021a15] border border-emerald-900 shadow-2xl overflow-hidden z-30">
                            ...
                            >
                                <div className="text-xs font-display uppercase tracking-widest">
                                    {gradientData.interpretations.pc1.name}
                                </div>
                                <div className="text-[9px] text-emerald-700 mt-1">
                                    {gradientData.interpretations.pc1.lowLabel} ↔ {gradientData.interpretations.pc1.highLabel}
                                </div>
                                <div className="text-[8px] text-emerald-800 mt-1">
                                    {gradientData.pca.pc1.variancePercent.toFixed(0)}% variance
                                </div>
                            </div>
                            ...
                            >
                                <div className="text-xs font-display uppercase tracking-widest">
                                    {gradientData.interpretations.pc2.name}
                                </div>
                                <div className="text-[9px] text-emerald-700 mt-1">
                                    {gradientData.interpretations.pc2.lowLabel} ↔ {gradientData.interpretations.pc2.highLabel}
                                </div>
                                <div className="text-[8px] text-emerald-800 mt-1">
                                    {gradientData.pca.pc2.variancePercent.toFixed(0)}% variance
                                </div>
                            </div>
                        </div>
                    )}
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    left: `${song.displayX}%`,
                                    top: `${song.displayY}%`,
                                    opacity: (isDimmed && selectedNode !== song.id) ? 0.25 : 1,
                                    width: `${40 / zoom}px`,
                                    height: `${40 / zoom}px`,
                                }}
            ...
            return (
                <div className="min-h-screen pt-32 px-6 max-w-2xl mx-auto animate-fade-in">
                    ...
                    <div className="prose prose-lg max-w-none font-body text-charcoal leading-relaxed">
                        <p>Aether Atlas is a digital journal focused on experimental music and the phenomenology of aesthetic experience.</p>
                        <p>Methodology:
                            -
                            - Nonmetric multi-dimensional scaling (NMDS) to visualise geometric relationships in aesthetic experience.</p>
                    </div>
